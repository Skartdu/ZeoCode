...
import com.ysc.aicodegenerator.mapper.ChatHistoryMapper;
import com.ysc.aicodegenerator.model.dto.chathistory.ChatHistoryQueryRequest;
import com.ysc.aicodegenerator.model.entity.App;
import com.ysc.aicodegenerator.model.entity.ChatHistory;
...
public class ChatHistoryServiceImpl extends ServiceImpl<ChatHistoryMapper, ChatHistory>  implements ChatHistoryService{
    ...
    public Page<ChatHistory> listAppChatHistoryByPage(Long appId, int pageSize, LocalDateTime lastCreateTime, User loginUser){
        ...
        ThrowUtils.throwIf(!isCreator&&!isAdmin,ErrorCode.NO_AUTH_ERROR,"无权查看该应用的对话历史");
        // 构建查询条件
